...
// start_btn1.onclick =()=>{
//     login.classList.add('activeInfo');
// }
...
// var next_btn = document.querySelector("header .next_btn ");
...
// var btn_2 =document.getElementById('btn1')
// console.log(btn_2);
// btn_2.onclick = ()=>{
//     que_count = 2;
//     que_numb = 2;
...
function showResult(){
    ...
    if (userScore > 8){ // if user scored more than 3
        ...
        // img.src="https://previews.123rf.com/images/viktorijareut/viktorijareut1811/viktorijareut181100429/112577255-raster-illustration-green-round-circle-pie-graph-chart-with-percentage-80-icon.jpg";
    }
